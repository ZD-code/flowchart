(function($) {
    ...
    myflow.props = function(o, r) {
        ...
        var showpropsHandler = function(e, props, src) {
            ...
            for (var k in props) {
                ...
                _tb.append('<tr id="myflowDelTR"><th>删除</th><td><input type="button" value="删除" onclick="if(confirm(\'确认删除？！\'))jQuery(document).trigger(\'keydown\',true);"/></td></tr>');
        };
    ...
    myflow.init = function(c, o) {
        ...
        $(document).keydown(function(arg, byButton) {
            if (!myflow.config.editable)
                return;
            if (arg.keyCode == 46 || byButton === true) {
